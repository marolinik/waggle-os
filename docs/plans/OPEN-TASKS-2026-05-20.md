...
|---|---|---|---|---|
| ✅ C-1 | **Phase 4 Memory Proof** (LOCOMO v5 + trio-strict) | ~~10~~ | **~$23 actual** | **Done end-to-end 2026-05-21.** Self-judge: 73.1% Opus 4.7 / 73.4% Qwen3.6, +4.6pp over Mem0 paper, N=320 stratified. **Trio-strict re-judge (2026-05-21)** with Opus 4.7 + GPT-5.5 + MiniMax M2.7: **57.5% strict / 71.6% on fully-parsed** (n=257); self-judge inflation +15.6pp (half of prior ~27pp estimate). Two-number framing published in `hive-mind/benchmarks/locomo/RESULTS.md` (commit `2f96e62`). Caveat: 63 MiniMax parse failures (19.7%) — fixable v0.3.x. |
...
| ✅ | **C-1 LOCOMO Memory Proof (trio-strict)** | Re-judged 2026-05-21 with Opus 4.7 + GPT-5.5 + MiniMax M2.7. **57.5% strict / 71.6% fully-parsed / 59.1% majority**. Self-judge inflation +15.6pp. Pairwise agreement 93-98%. Published in `hive-mind/benchmarks/locomo/RESULTS.md` + script at `38-judge-trio-v5.mjs` (commit `2f96e62`). ~$12-14 spend, 49 min wall-clock. |
