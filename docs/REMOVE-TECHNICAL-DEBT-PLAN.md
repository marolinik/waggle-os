...
- [ ] Pin the four `buildChatCommandContext` behaviors listed in the TESTING.md Characterization Backlog (agent, `test(server):` commit, before Phase 4 touches the helper)
