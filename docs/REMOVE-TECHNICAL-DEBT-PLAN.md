...
- [ ] TD-CHAT-23 trust half: blocked on founder decision **F2** (the fix loosens an always-denied critical child `bash` call). Needs the approval-hook pins first — `chat.ts:3602-3762` has no executing test (agent)
