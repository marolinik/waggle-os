...
export const PERSONA_CASES: readonly PersonaAcceptanceCase[] = [
  ...
  },
  {
    ...
    responseRules: [
      ...
      { id: 'fact-inference', description: 'Separates sourced facts from inference', kind: 'allPatterns', patterns: [/\bfacts?\b/i, /\binference\b/i], points: 10 },
  ...
  },
  {
    ...
    responseRules: [
      ...
      { id: 'empty-result', description: 'Accurately reports the fresh virtual workspace as empty', kind: 'pattern', pattern: /(?:empty|no files? (?:exist|found|present))/i, points: 10 },
