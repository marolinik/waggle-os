        ...
        criteria: [
          ...
          },
          {
            ...
            basisFamilies: [
              ...
              /\b(?:high(?:est)? leverage|less urgent|least urgent|not urgent|not as time[- ]sensitive|less time[- ]sensitive|structural|systemic fix|process problem|requires? (?:diagnosis|product\/design coordination|coordination and validation)|better inputs|future throughput|long[- ]term ROI|rarely time[- ]boxed|compounds? over time)\b/i,
            ],
          },
        ],
        points: 10,
