 ...
 * gated on Clerk config (D2(b)): with a key, the themed Clerk <SignIn/>/<SignUp/>
 * (B2); without one, the honest accountless local-first state (B1). The gate matches
 * WaggleClerkProvider's — both read the same key, so ClerkAuthForm only renders when a
