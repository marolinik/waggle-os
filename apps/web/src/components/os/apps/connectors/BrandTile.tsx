...
const BrandTile = ({
  ...
  return (
    <div
      className={`relative shrink-0 overflow-hidden rounded-[14px] shadow-lg transition-shadow duration-mo-base group-hover:shadow-xl ${className}`}
      style={{
        width: size,
        height: size,
    ...
    >
      ...
      <div
        className="pointer-events-none absolute inset-0 rounded-[14px] opacity-0 transition-opacity duration-mo-base group-hover:opacity-100"
        style={{
          background:
