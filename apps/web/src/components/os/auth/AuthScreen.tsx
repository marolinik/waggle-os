 ...
 *
 * Left brand panel (hidden < 820px) + right form panel (`children`). This is the ONE
...
export default function AuthScreen({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen grid min-[820px]:grid-cols-[1.05fr_1fr] bg-background text-foreground">
      <AuthBrandPanel />
