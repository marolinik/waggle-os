...
// ── Extracted modules ──────────────────────────────────────────────────
import { actionableMemoryDirectiveText, allowsConversationHistory, allowsPersistedMemoryRead, allowsPostResponseDecoration, canUseBudgetModelWithoutCloudEgress, classifyExplicitTurnMutationPolicy, isExplicitToolFreeAdvisoryRequest, isOfflineOllamaModelReference, primeMemoryDirectiveClassifier, resolveExplicitPersistedMemoryReadDirective, resolveTurnPersistencePermissions, describeToolUseSafe, type TurnContextScope, type TurnMutationPolicy } from './chat-helpers.js';
import {
  chatSessionStateKey,
